...
class TarjetaEstadistica extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final colorTendencia = esIncremento ? const Color(0xFF22C55E) : const Color(0xFFEF4444);

    // Colores adaptativos según modo
    final cardBg = isDarkMode ? const Color(0xFF1E2A3A) : Colors.white;
    final borderColor = isDarkMode ? colorIcono.withOpacity(0.35) : colorIcono.withOpacity(0.25);
    ...
    final iconBg = isDarkMode ? colorIcono.withOpacity(0.18) : colorIcono.withOpacity(0.1);
    final trendBg = isDarkMode
        ? colorTendencia.withOpacity(0.18)
        : colorTendencia.withOpacity(0.1);
