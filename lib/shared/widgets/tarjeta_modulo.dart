...
class TarjetaModulo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final borderColor = isDarkMode ? Colors.white.withOpacity(0.07) : Colors.grey.shade100;
                      ...
                      TextButton(
                        ...
                        child: Row(
                          children: [
                            ...
                            Icon(Icons.arrow_forward_rounded, size: 16, color: colorTema),
                          ],
                        ),
                      ),
                    ],
